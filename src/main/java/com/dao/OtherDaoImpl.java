...
public class OtherDaoImpl extends BaseDao<EntityModel> implements otherDao {
    ...
    @Override
    public void insertFollow(String cid, String eid) {
        String sql = "insert into myfocus(cid,eid) values(?,?)";
        update(connection, sql, cid, eid);
    }

    @Override
    public void deleteFollow(String cid, String eid) {
        String sql = "delete from myfocus where cid = ? and eid = ?";
        update(connection, sql, cid, eid);
    }

    @Override
    public List<EntityModel> getFollow(String cid, String eid) {
        String sql = "select * from myfocus where cid = ? and eid = ?";
